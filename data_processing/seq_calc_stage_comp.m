function dataplot_norm = seq_calc_stage_comp(sbj_name,project_name, elecs, block_names, dirs, tag, column, conds, datatype, freq_band, stats_params)
...
for ii = 1:length(data_all_avg.math)
    dataplot_norm.math{i} =  mat2gray(dataplot.math{i});
    dataplot_norm.autobio{i} =  mat2gray(dataplot.autobio{i});
end
