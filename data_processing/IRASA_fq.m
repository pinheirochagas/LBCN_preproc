...
%         % See why negative, if negative set to 0.        
        ...
        IRASA.(['el_' globalVar.channame{iel}]).(conds{i}).orig = orig;
        IRASA.(['el_' globalVar.channame{iel}]).(conds{i}).frac = frac;
        IRASA.(['el_' globalVar.channame{iel}]).(conds{i}).osci = osci;
    end
