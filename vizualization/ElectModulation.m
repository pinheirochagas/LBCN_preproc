function [el_selectivity, sm_data, sc1c2, sc1b1, sc2b2] = ElectModulation(sbj_name,project_name, block_names, dirs, tag, column, conds, datatype, freq_band, stats_params)
