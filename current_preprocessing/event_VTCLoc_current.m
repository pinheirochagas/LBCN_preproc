...
K= load(sprintf('%s/sodata.S14_64_SP.29.03.2014.15.58.mat',globalVar.psych_dir)); % 03
...
stim_ind(1:13)=[]; %to skip misc. diode
...
categNames= {'animals','faces','falsefonts','logos','numbers','places','spanish_words','words','persian_numbers'};
