...
% sbjs= {'S09_06_RM','S09_07_CM','S10_18_JBXa','S11_20_RHb','S11_26_SRb','S11_29_RB','S12_33_DA','S12_38_LK','S12_42_NC','S13_47_JT2','S13_56_THS','S14_74_OD','S15_83_RR'};
sbjs = {'S18_122'};
project_name= 'MMR';
...
for si = 1:length(sbjs)
    ...
    for bi = 1:length(BN)
        ...
        for e = 1:length(elecs)
            ...
            globalVar.bad_epochs(ei).timepoints=find(bad_data);
