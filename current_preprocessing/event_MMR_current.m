...
K= load(sprintf('%s/sodata.S14_75_TB_02.24.09.2014.12.19.mat',globalVar.psych_dir)); % 
...
load(sprintf('%s/OriginalData/%s/%s/Pdio%s_02.mat',data_root,sbj_name,block_name,block_name));
