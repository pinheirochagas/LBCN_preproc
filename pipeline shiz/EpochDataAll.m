function EpochDataAll(sbj_name, project_name, bn, dirs,elecs,locktype,bef_time,aft_time,datatype,thr_raw,thr_diff)
...
for ei = 1:length(elecs)
    ...
    save(fn_out,'data')
    disp(['Data epoching: Block ', bn,', Elec ',num2str(el)])
end
