function WaveletFilterAll(sbj_name, project_name, block_names, dirs,elecs,freq_band,span,fs_targ, norm, avgfreq)
%% INPUTS
...
for bi = 1:length(block_names)
    ...
    for ei = 1:length(elecs)
        ...
        if strcmp(freq_band,'HFB')
            ...
            fn_out = sprintf('%s/SpectiEEG%s_%.2d.mat',dir_out,bn,el);
        end
        save(fn_out,'data')
        disp(['Wavelet filtering: Block ', num2str(bi),', Elec ',num2str(el)])
    end
